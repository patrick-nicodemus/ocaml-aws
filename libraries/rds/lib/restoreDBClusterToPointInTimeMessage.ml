...
type t =
  ...
  ; source_db_cluster_resource_id : String.t option
...
let parse xml =
  Some
    ...
    ; restore_type = Aws.Util.option_bind (Aws.Xml.member "RestoreType" xml) String.parse
    ; source_d_b_cluster_identifier =
    ...
    ; source_db_cluster_resource_id =
        Aws.Util.option_bind (Aws.Xml.member "SourceDbClusterResourceId" xml) String.parse
    ; serverless_v2_scaling_configuration =
        Aws.Util.option_bind
...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       ; Aws.Util.option_map v.source_db_cluster_resource_id (fun f ->
             Aws.Query.Pair ("SourceDbClusterResourceId", String.to_query f))
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       ; Aws.Util.option_map v.source_db_cluster_resource_id (fun f ->
             "SourceDbClusterResourceId", String.to_json f)
...
let of_json j =
  ...
  ; source_db_cluster_resource_id =
      Aws.Util.option_map (Aws.Json.lookup j "SourceDbClusterResourceId") String.of_json
  ; serverless_v2_scaling_configuration =
      Aws.Util.option_map
