...
type t =
  ...
  ; source_d_b_instance_automated_backups_arn : String.t option
...
let make
    ...
    ?network_type
    ?source_d_b_instance_automated_backups_arn
    ?backup_target
...
let parse xml =
  Some
    ...
    ; use_latest_restorable_time =
        Aws.Util.option_bind (Aws.Xml.member "UseLatestRestorableTime" xml) Boolean.parse
    ; d_b_instance_class =
    ...
    ; source_d_b_instance_automated_backups_arn =
        Aws.Util.option_bind
          (Aws.Xml.member "SourceDBInstanceAutomatedBackupsArn" xml)
          String.parse
    ; backup_target =
...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       ; Aws.Util.option_map v.source_d_b_instance_automated_backups_arn (fun f ->
             Aws.Query.Pair ("SourceDBInstanceAutomatedBackupsArn", String.to_query f))
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       ; Aws.Util.option_map v.source_d_b_instance_automated_backups_arn (fun f ->
             "SourceDBInstanceAutomatedBackupsArn", String.to_json f)
       ...
       ; Some
           ("TargetDBInstanceIdentifier", String.to_json v.target_d_b_instance_identifier)
       ; Aws.Util.option_map v.source_d_b_instance_identifier (fun f ->
...
let of_json j =
  ...
  ; restore_time = Aws.Util.option_map (Aws.Json.lookup j "RestoreTime") DateTime.of_json
  ; use_latest_restorable_time =
  ...
  ; source_d_b_instance_automated_backups_arn =
      Aws.Util.option_map
        (Aws.Json.lookup j "SourceDBInstanceAutomatedBackupsArn")
        String.of_json
