...
type t =
  ...
  ; set_for_delete : Boolean.t option
  }
...
let parse xml =
  Some
    ...
    ; set_for_delete =
        Aws.Util.option_bind (Aws.Xml.member "SetForDelete" xml) Boolean.parse
    }

let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       [ Aws.Util.option_map v.set_for_delete (fun f ->
             Aws.Query.Pair ("SetForDelete", Boolean.to_query f))
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       [ Aws.Util.option_map v.set_for_delete (fun f -> "SetForDelete", Boolean.to_json f)
...
let of_json j =
  ...
  ; set_for_delete =
      Aws.Util.option_map (Aws.Json.lookup j "SetForDelete") Boolean.of_json
  }
