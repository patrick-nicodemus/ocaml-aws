...
type t =
  ...
  ; association_target : InstanceEventWindowAssociationRequest.t
  }
    ...
    ; association_target =
        Aws.Xml.required
          ...
          (Aws.Util.option_bind
             ...
             InstanceEventWindowAssociationRequest.parse)
    }
  ...
  Aws.Query.List
    (Aws.Util.list_filter_opt
       [ Some
           (Aws.Query.Pair
              ( "AssociationTarget"
              , InstanceEventWindowAssociationRequest.to_query v.association_target ))
       ; Some
           (Aws.Query.Pair
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       [ Some
           ( "AssociationTarget"
           , InstanceEventWindowAssociationRequest.to_json v.association_target )
...
let of_json j =
  ...
  ; association_target =
      InstanceEventWindowAssociationRequest.of_json
