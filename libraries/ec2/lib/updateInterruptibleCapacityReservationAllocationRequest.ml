  ...
  Some
    {
      ...
      target_instance_count =
        (Aws.Xml.required "TargetInstanceCount"
  ...
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       Some
         (Aws.Query.Pair
            ("TargetInstanceCount",
              (Integer.to_query v.target_instance_count)));
       Some
         (Aws.Query.Pair
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       Some
         ("TargetInstanceCount", (Integer.to_json v.target_instance_count));
       Some
         ("CapacityReservationId",
...
let of_json j =
  {
    ...
    target_instance_count =
      (Integer.of_json
         (Aws.Util.of_option_exn (Aws.Json.lookup j "TargetInstanceCount")));
    dry_run =
