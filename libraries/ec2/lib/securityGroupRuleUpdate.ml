  ...
  Some
    {
      security_group_rule_id =
        (Aws.Xml.required "SecurityGroupRuleId"
  ...
  Aws.Query.List
    (Aws.Util.list_filter_opt
       [Aws.Util.option_map v.security_group_rule
          (fun f ->
             Aws.Query.Pair
               ("SecurityGroupRule", (SecurityGroupRuleRequest.to_query f)));
       Some
         (Aws.Query.Pair
            ("SecurityGroupRuleId",
              (String.to_query v.security_group_rule_id)))])
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       [Aws.Util.option_map v.security_group_rule
       ...
       Some
         ("SecurityGroupRuleId", (String.to_json v.security_group_rule_id))])
let of_json j =
  {
    security_group_rule_id =
      (String.of_json
