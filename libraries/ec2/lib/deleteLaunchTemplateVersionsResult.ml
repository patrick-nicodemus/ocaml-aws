      ...
      successfully_deleted_launch_template_versions =
        (Aws.Util.of_option []
           (Aws.Util.option_bind
              (Aws.Xml.member "successfullyDeletedLaunchTemplateVersionSet"
                 xml) DeleteLaunchTemplateVersionsResponseSuccessSet.parse));
      unsuccessfully_deleted_launch_template_versions =
        (Aws.Util.of_option []
           (Aws.Util.option_bind
              (Aws.Xml.member "unsuccessfullyDeletedLaunchTemplateVersionSet"
