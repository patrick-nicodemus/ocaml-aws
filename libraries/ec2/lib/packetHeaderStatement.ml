  ...
  Some
    {
      source_addresses =
        (Aws.Util.of_option []
           (Aws.Util.option_bind (Aws.Xml.member "sourceAddressSet" xml)
              ValueStringList.parse));
      destination_addresses =
        (Aws.Util.of_option []
           (Aws.Util.option_bind (Aws.Xml.member "destinationAddressSet" xml)
              ValueStringList.parse));
      source_ports =
        (Aws.Util.of_option []
      ...
      source_prefix_lists =
        (Aws.Util.of_option []
           (Aws.Util.option_bind (Aws.Xml.member "sourcePrefixListSet" xml)
              ValueStringList.parse));
      destination_prefix_lists =
        (Aws.Util.of_option []
...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       [Some
          (Aws.Query.Pair
             ("ProtocolSet", (ProtocolList.to_query v.protocols)));
       Some
         (Aws.Query.Pair
       ...
       Some
         (Aws.Query.Pair
            ("SourcePortSet", (ValueStringList.to_query v.source_ports)));
       Some
         (Aws.Query.Pair
       ...
       Some
         (Aws.Query.Pair
            ("SourceAddressSet",
              (ValueStringList.to_query v.source_addresses)))])
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
    ...
    destination_prefix_lists =
      (ValueStringList.of_json
         (Aws.Util.of_option_exn
            (Aws.Json.lookup j "destinationPrefixListSet")));
    protocols =
