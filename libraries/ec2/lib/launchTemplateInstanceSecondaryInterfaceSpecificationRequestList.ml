...
let to_query v =
  Aws.Query.to_query_list
    LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest.to_query v
let to_json v =
  `List
    (List.map
       LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest.to_json v)
let of_json j =
  Aws.Json.to_list
    LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest.of_json j