...
let make ~network_interface_id  ?aws_account_id  ?aws_service  ~permission 
  ?dry_run  () =
...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       Some
         (Aws.Query.Pair
            ("Permission", (InterfacePermissionType.to_query v.permission)));
