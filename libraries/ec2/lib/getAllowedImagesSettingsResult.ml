  ...
  Some
    {
      ...
      image_criteria =
        (Aws.Util.of_option []
           (Aws.Util.option_bind (Aws.Xml.member "imageCriterionSet" xml)
  ...
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       Some
         (Aws.Query.Pair
            ("ImageCriterionSet",
              (ImageCriterionList.to_query v.image_criteria)));
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       Some
         ("imageCriterionSet", (ImageCriterionList.to_json v.image_criteria));
