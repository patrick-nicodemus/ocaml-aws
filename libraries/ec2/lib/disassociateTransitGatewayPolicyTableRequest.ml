...
let make ~transit_gateway_policy_table_id ~transit_gateway_attachment_id ?dry_run () =
  { transit_gateway_policy_table_id; transit_gateway_attachment_id; dry_run }
...
let of_json j =
  { transit_gateway_policy_table_id =
      String.of_json
        (Aws.Util.of_option_exn (Aws.Json.lookup j "TransitGatewayPolicyTableId"))
  ; transit_gateway_attachment_id =
      String.of_json
