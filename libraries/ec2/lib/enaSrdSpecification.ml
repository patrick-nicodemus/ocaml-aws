...
type t =
  ...
  ; ena_srd_udp_specification : EnaSrdUdpSpecification.t option
  }
  ...
  Aws.Query.List
    (Aws.Util.list_filter_opt
       [ Aws.Util.option_map v.ena_srd_udp_specification (fun f ->
             Aws.Query.Pair ("EnaSrdUdpSpecification", EnaSrdUdpSpecification.to_query f))
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       [ Aws.Util.option_map v.ena_srd_udp_specification (fun f ->
             "EnaSrdUdpSpecification", EnaSrdUdpSpecification.to_json f)
       ; Aws.Util.option_map v.ena_srd_enabled (fun f ->
...
let of_json j =
  ...
  ; ena_srd_udp_specification =
      Aws.Util.option_map
        ...
        EnaSrdUdpSpecification.of_json
  }
