  ...
  Some
    {
      ...
      default_association_route_table =
        (Aws.Util.option_bind
           (Aws.Xml.member "defaultAssociationRouteTable" xml) Boolean.parse);
      default_propagation_route_table =
        (Aws.Util.option_bind
           (Aws.Xml.member "defaultPropagationRouteTable" xml) Boolean.parse);
      creation_time =
...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       Aws.Util.option_map v.default_propagation_route_table
         (fun f ->
            Aws.Query.Pair
              ("DefaultPropagationRouteTable", (Boolean.to_query f)));
       Aws.Util.option_map v.default_association_route_table
         (fun f ->
            Aws.Query.Pair
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       Aws.Util.option_map v.default_propagation_route_table
         (fun f -> ("defaultPropagationRouteTable", (Boolean.to_json f)));
       Aws.Util.option_map v.default_association_route_table
         (fun f -> ("defaultAssociationRouteTable", (Boolean.to_json f)));
       Aws.Util.option_map v.state
...
let of_json j =
  {
    ...
    default_association_route_table =
      (Aws.Util.option_map (Aws.Json.lookup j "defaultAssociationRouteTable")
         Boolean.of_json);
    default_propagation_route_table =
      (Aws.Util.option_map (Aws.Json.lookup j "defaultPropagationRouteTable")
         Boolean.of_json);
    creation_time =
