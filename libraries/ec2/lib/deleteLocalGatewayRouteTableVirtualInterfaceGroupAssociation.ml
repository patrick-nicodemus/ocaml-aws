    ...
    try
      Util.or_error
        (Util.option_bind resp
           DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult.parse)
        (let open Error in
           BadResponse
             {
               body;
               message =
                 "Could not find well formed DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult."
             })
    with
            ...
            (BadResponse
               {
                 body;
                 message =
                   ("Error parsing DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult - missing field in body or children: "
                      ^ msg)
               })
  with
  | Failure msg ->
