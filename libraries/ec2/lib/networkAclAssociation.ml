  ...
  Some
    {
      network_acl_association_id =
        (Aws.Util.option_bind (Aws.Xml.member "networkAclAssociationId" xml)
           String.parse);
      network_acl_id =
...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       Aws.Util.option_map v.network_acl_association_id
         (fun f ->
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       Aws.Util.option_map v.network_acl_association_id
         (fun f -> ("networkAclAssociationId", (String.to_json f)))])
let of_json j =
  {
    network_acl_association_id =
      (Aws.Util.option_map (Aws.Json.lookup j "networkAclAssociationId")
         String.of_json);
    network_acl_id =
