  ...
  Some
    { code =
        Aws.Util.option_bind
          ...
          VerifiedAccessEndpointStatusCode.parse
  ...
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       ; Aws.Util.option_map v.code (fun f ->
             Aws.Query.Pair ("Code", VerifiedAccessEndpointStatusCode.to_query f))
       ])
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       ; Aws.Util.option_map v.code (fun f ->
             "code", VerifiedAccessEndpointStatusCode.to_json f)
       ])
...
let of_json j =
  { code =
      Aws.Util.option_map
        ...
        VerifiedAccessEndpointStatusCode.of_json
