  ...
  Some
    {
      classic_link_dns_supported =
        (Aws.Util.option_bind (Aws.Xml.member "classicLinkDnsSupported" xml)
           Boolean.parse);
      vpc_id =
...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       Aws.Util.option_map v.classic_link_dns_supported
         (fun f ->
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       Aws.Util.option_map v.classic_link_dns_supported
         (fun f -> ("classicLinkDnsSupported", (Boolean.to_json f)))])
let of_json j =
  {
    classic_link_dns_supported =
      (Aws.Util.option_map (Aws.Json.lookup j "classicLinkDnsSupported")
         Boolean.of_json);
