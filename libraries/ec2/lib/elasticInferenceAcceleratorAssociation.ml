  ...
  Some
    {
      elastic_inference_accelerator_arn =
        (Aws.Util.option_bind
           (Aws.Xml.member "elasticInferenceAcceleratorArn" xml) String.parse);
      elastic_inference_accelerator_association_id =
        (Aws.Util.option_bind
...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       [Aws.Util.option_map v.elastic_inference_accelerator_association_time
          (fun f ->
             Aws.Query.Pair
               ("ElasticInferenceAcceleratorAssociationTime",
                 (DateTime.to_query f)));
       Aws.Util.option_map v.elastic_inference_accelerator_association_state
         (fun f ->
            Aws.Query.Pair
              ("ElasticInferenceAcceleratorAssociationState",
                (String.to_query f)));
       Aws.Util.option_map v.elastic_inference_accelerator_association_id
         (fun f ->
            Aws.Query.Pair
              ("ElasticInferenceAcceleratorAssociationId",
                (String.to_query f)));
       Aws.Util.option_map v.elastic_inference_accelerator_arn
         (fun f ->
            Aws.Query.Pair
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       Aws.Util.option_map v.elastic_inference_accelerator_arn
         (fun f -> ("elasticInferenceAcceleratorArn", (String.to_json f)))])
let of_json j =
  {
    elastic_inference_accelerator_arn =
      (Aws.Util.option_map
         (Aws.Json.lookup j "elasticInferenceAcceleratorArn") String.of_json);
    elastic_inference_accelerator_association_id =
      (Aws.Util.option_map
