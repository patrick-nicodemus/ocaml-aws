  ...
  Some
    ...
    ; state =
        Aws.Util.option_bind
          ...
          SecondarySubnetCidrBlockAssociationState.parse
  ...
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       ; Aws.Util.option_map v.state (fun f ->
             Aws.Query.Pair ("State", SecondarySubnetCidrBlockAssociationState.to_query f))
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       ; Aws.Util.option_map v.state (fun f ->
             "state", SecondarySubnetCidrBlockAssociationState.to_json f)
...
let of_json j =
  ...
  ; state =
      Aws.Util.option_map
        ...
        SecondarySubnetCidrBlockAssociationState.of_json
