...
let make ?destination_prefix_list_id  ?vpc_endpoint_id  ?transit_gateway_id 
  ?local_gateway_id  ?carrier_gateway_id  ?core_network_arn  ?odb_network_arn
   ?dry_run  ~route_table_id  ?destination_cidr_block  ?gateway_id 
  ?destination_ipv6_cidr_block  ?egress_only_internet_gateway_id 
