  ...
  Some
    {
      ...
      total_inference_memory_in_mi_b =
        (Aws.Util.option_bind
           (Aws.Xml.member "totalInferenceMemoryInMiB" xml) Integer.parse)
    }
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       [Aws.Util.option_map v.total_inference_memory_in_mi_b
          (fun f ->
             Aws.Query.Pair
               ("TotalInferenceMemoryInMiB", (Integer.to_query f)));
       Some
         (Aws.Query.Pair
            ("Accelerators",
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       [Aws.Util.option_map v.total_inference_memory_in_mi_b
          (fun f -> ("totalInferenceMemoryInMiB", (Integer.to_json f)));
       Some
         ("accelerators", (InferenceDeviceInfoList.to_json v.accelerators))])
let of_json j =
  {
    accelerators =
    ...
    total_inference_memory_in_mi_b =
      (Aws.Util.option_map (Aws.Json.lookup j "totalInferenceMemoryInMiB")
         Integer.of_json)
  }