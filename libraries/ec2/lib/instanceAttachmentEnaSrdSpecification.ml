...
type t =
  ...
  ; ena_srd_udp_specification : InstanceAttachmentEnaSrdUdpSpecification.t option
  }
  ...
  Some
    ...
    ; ena_srd_udp_specification =
        Aws.Util.option_bind
          ...
          InstanceAttachmentEnaSrdUdpSpecification.parse
    }
    ...
    (Aws.Util.list_filter_opt
       [ Aws.Util.option_map v.ena_srd_udp_specification (fun f ->
             Aws.Query.Pair
               ...
               , InstanceAttachmentEnaSrdUdpSpecification.to_query f ))
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       [ Aws.Util.option_map v.ena_srd_udp_specification (fun f ->
             "enaSrdUdpSpecification", InstanceAttachmentEnaSrdUdpSpecification.to_json f)
       ; Aws.Util.option_map v.ena_srd_enabled (fun f ->
...
let of_json j =
  ...
  ; ena_srd_udp_specification =
      Aws.Util.option_map
        ...
        InstanceAttachmentEnaSrdUdpSpecification.of_json
  }
