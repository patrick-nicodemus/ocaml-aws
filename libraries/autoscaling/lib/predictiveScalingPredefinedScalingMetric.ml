...
type t =
  { predefined_metric_type : PredefinedScalingMetricType.t
    ...
    { predefined_metric_type =
        Aws.Xml.required
          ...
          (Aws.Util.option_bind
             ...
             PredefinedScalingMetricType.parse)
    ; resource_label =
  ...
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       ; Some
           (Aws.Query.Pair
              ( "PredefinedMetricType"
              , PredefinedScalingMetricType.to_query v.predefined_metric_type ))
       ])
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       ; Some
           ( "PredefinedMetricType"
           , PredefinedScalingMetricType.to_json v.predefined_metric_type )
       ])

let of_json j =
  { predefined_metric_type =
      PredefinedScalingMetricType.of_json
