...
let to_query v =
  Aws.Query.List
    (Aws.Util.list_filter_opt
       ...
       ; Some
           (Aws.Query.Pair ("LifecycleTransition", String.to_query v.lifecycle_transition))
       ; Some
...
let to_json v =
  `Assoc
    (Aws.Util.list_filter_opt
       ...
       ; Some ("LifecycleTransition", String.to_json v.lifecycle_transition)
...
let of_json j =
  ...
  ; lifecycle_transition =
      String.of_json (Aws.Util.of_option_exn (Aws.Json.lookup j "LifecycleTransition"))
  ; notification_metadata =
